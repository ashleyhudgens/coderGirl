...
public class catAndMouse
{
    public static void main(String[] args)
    {
        ...
        out.println("You are a small, hungry, field mouse. You find yourself standing in a hole in the");
        ...
        out.println();
        if (firstChoice.equalsIgnoreCase("chair"))
        {
            out.println("You sneak quietly to the chair and climb its rough wood. The only place you can reach");
            out.println("From here is the table, so you climp it too. Looking around from the table, you see two");
            ...
            if (secondChoice.equalsIgnoreCase("window"))
            {
            ...
            if (secondChoice.equalsIgnoreCase("floor"))
            {
                out.println("You try to climb down the table leg but it's too spippery. Thump! You hit the floor with a");
        ...
        } else if (firstChoice.equalsIgnoreCase("table"))
        {
            ...
            out.println("and back into the mouse hole! Exhausted and hungry, you give up for the day. (The End)");
        } else if(firstChoice.equalsIgnoreCase("lamp"))
        {
        ...
        } else if(firstChoice.equalsIgnoreCase("food"))
        {
            ...
            out.println();
            out.println("Where do you eat? Options: floor, dish");
            thirdChoice = keyboard.nextLine();
            if (thirdChoice.equalsIgnoreCase("floor"))
            {
                ...
                fourthChoice = keyboard.nextLine();
                if (fourthChoice.equalsIgnoreCase("dish"))
                {
                    out.println("The cat food rattles loudly as you climb into the cat dish. The cat wakes up! And");
                ...
                } else if(fourthChoice.equalsIgnoreCase("curtain"))
                {
                    out.println("You quietly sneak over to the curtain. The cat wakes up slow and groggy. You've");
                    out.println("already made it to the curtain by the time he notices your. With a burst of well-fed");
        ...
        } else if(firstChoice.equalsIgnoreCase("curtain"))
        {
            ...
            fifthChoice = keyboard.nextLine();
            if (fifthChoice.equalsIgnoreCase("down"))
            {
            ...
            } else if(fifthChoice.equalsIgnoreCase("window"))
            {
